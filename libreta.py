...
def LibretaMilitar(m):
    ...
    try:
        ...
        driver = webdriver.Chrome(executable_path="chromedriver2.exe")
        ...
        ent = TRX.addEntity('maltego.Person', nombre.encode('utf8'))
        ent2 = TRX.addEntity('eci.libreta', libreta.encode('utf8'))
